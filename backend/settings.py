...
SECRET_KEY = 'django-insecure-@pvg^n4)9$t6ymdqkek&6&t)y8er(d1fquaw29=1w=l@(#5r60'
...
STORAGES = {
    "default": {
        ...
        "LOCATION": MEDIA_ROOT,  # Make sure MEDIA_ROOT is set
    },
    "staticfiles": {
